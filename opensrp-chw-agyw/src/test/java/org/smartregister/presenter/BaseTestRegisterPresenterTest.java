...
import org.smartregister.chw.agyw.contract.TestRegisterContract;
import org.smartregister.chw.agyw.presenter.BaseTestRegisterPresenter;

@PrepareForTest(BaseTestRegisterPresenter.class)
public class BaseTestRegisterPresenterTest {
    @Mock
    protected BaseTestRegisterPresenter baseTestRegisterPresenter;

    @Mock
    protected TestRegisterContract.Interactor interactor;
    @Mock
    protected TestRegisterContract.Model model;
    @Mock
    protected TestRegisterContract.View baseView;
    private BaseTestRegisterPresenter presenter;

    @Before
    public void setUp() {
        MockitoAnnotations.initMocks(this);
        presenter = new BaseTestRegisterPresenter(baseView, model, interactor);
    }
    ...
    public void getViewWhenViewIsNull() throws Exception {
        Assert.assertNull(Whitebox.invokeMethod(baseTestRegisterPresenter, "getView"));
    }

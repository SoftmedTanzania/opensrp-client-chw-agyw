package org.smartregister.chw.agyw;
...
public class AGYWLibrary {
    private static AGYWLibrary instance;
    ...
    public static void init(Context context, Repository repository, int applicationVersion, int databaseVersion) {
        if (instance == null) {
            instance = new AGYWLibrary(context, repository, applicationVersion, databaseVersion);
        }
    }

    public static AGYWLibrary getInstance() {
        if (instance == null) {
    ...
    private AGYWLibrary(Context contextArg, Repository repositoryArg, int applicationVersion, int databaseVersion) {

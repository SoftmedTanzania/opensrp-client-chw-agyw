package org.smartregister.chw.agyw.provider;
...
public class AGYWRegisterProvider implements RecyclerViewProvider<AGYWRegisterProvider.RegisterViewHolder> {
    ...
    public AGYWRegisterProvider(Context context, View.OnClickListener paginationClickListener, View.OnClickListener onClickListener, Set visibleColumns) {
    ...
    private String updateMemberGender(CommonPersonObjectClient commonPersonObjectClient) {
        if ("0".equals(Utils.getValue(commonPersonObjectClient.getColumnmaps(), DBConstants.KEY.IS_ANC_CLOSED, false))) {
            ...
            return AGYWUtil.getGenderTranslated(context, gender);
        }
    }
...
//        implement
    ...
    public RegisterViewHolder createViewHolder(ViewGroup parent) {
        View view = inflater.inflate(R.layout.agyw_register_list_row, parent, false);

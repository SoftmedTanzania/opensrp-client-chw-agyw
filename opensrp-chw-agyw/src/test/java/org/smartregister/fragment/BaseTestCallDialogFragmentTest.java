...
import org.smartregister.chw.agyw.fragment.BaseTestCallDialogFragment;

@PrepareForTest(BaseTestCallDialogFragment.class)
public class BaseTestCallDialogFragmentTest {
    @Spy
    public BaseTestCallDialogFragment baseTestCallDialogFragment;
    ...
    public void setUp() {
        ...
        Whitebox.setInternalState(BaseTestCallDialogFragment.class, "MEMBER_OBJECT", memberObject);
    }
    ...
    public void setCallTitle() throws Exception {
        ...
        Whitebox.invokeMethod(baseTestCallDialogFragment, "setCallTitle", viewGroup, view.getId(), "message");
        Assert.assertEquals("message Agyw Client", textView.getText());
    }

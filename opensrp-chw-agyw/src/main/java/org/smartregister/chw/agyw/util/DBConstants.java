...
public class DBConstants {
    ...
    public final class KEY {
        ...
        public static final String DATE_CHW_AGYW_TEST = "date_chw_agyw_test";
        public static final String FEVER_AGYW_CHW = "fever_agyw_chw";
        public static final String FEVER_DURATION = "fever_duration";
        public static final String AGYW_RESULTS = "agyw_results";
        public static final String DATE_HF_AGYW_TEST = "date_hf_agyw_test";
        public static final String AGYW_TEST_DATE = "agyw_test_date";
        public static final String AGYW_TREAT = "agyw_treat";
        ...
        public static final String AGYW_EDU_CHW = "agyw_edu_chw";
        ...
        public static final String PHONE_NUMBER_AGYW = "phoneNumberAgyw";
        public static final String GEST_AGE = "gest_age";
        public static final String DELIVERY_DATE = "delivery_date";
        public static final String AGYW_FOLLOW_UP_DATE = "date_chw_mfollowup";
